...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2026/02/07 14:38:27 by bzoto             #+#    #+#             */
/*   Updated: 2026/02/07 15:07:56 by bzoto            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void small_sord(t_stack **st)
{
	...
	if (max_id == (*st)->main_index)
		rotate_move(st, NULL, "ra");
	else if (max_id == (*st)->next->main_index)
		rotate_move(st, NULL, "sa");
